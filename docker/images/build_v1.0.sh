...
COMPOSE_DOCKER_CLI_BUILD=1 DOCKER_BUILDKIT=1 "${CICD_SCRIPTS_TOOLS_DIR}"/docker-compose -f "${DOCKER_COMPOSE_ORIGINAL_PATH}" --project-directory "${GENERATED_DIRECTORY}" pull
echo
